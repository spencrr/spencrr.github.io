...
const getSrc = (path: string) =>
  new URL(`/src/assets/projects/${path}`, import.meta.url).href;
...
const projects = ({ getAnchorTag }: ProjectConfig): Project[] => [
  {
    ...
    media: "vid",
    src: getSrc("schellings-model.mp4"),
  ...
  },
  {
    ...
    href: "https://github.com/spencrr/processing-projects/tree/master/Cellular%20Automata/GameOfLife",
    media: "vid",
    src: getSrc("game-of-life.mp4"),
  ...
  },
  {
    ...
    href: "https://github.com/spencrr/processing-projects/tree/master/Math%20Visualizations/JuliaSetsMandelbrotSet",
    media: "vid",
    src: getSrc("julia-sets.mp4"),
  ...
  },
  {
    ...
    href: "https://github.com/spencrr/processing-projects/tree/master/Math%20Visualizations/FibonacciSpiral",
    media: "vid",
    src: getSrc("fibonacci-spiral.mp4"),
  ...
  },
  {
    ...
    shouldInvert: true,
    desc: "Not every project has been fully documented yet, so feel free to check out more of my work, or see the inner workings of each project.",
  },
];
